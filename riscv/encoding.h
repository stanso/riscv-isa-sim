 ...
 * https://github.com/riscv/riscv-opcodes (3c4905e)
 */
...
DECLARE_INSN(vsbindle64_v, MATCH_VSBINDLE64_V, MASK_VSBINDLE64_V)
...
DECLARE_CSR(vmmergeposcolli, CSR_VMMERGEPOSCOLLI)
DECLARE_CSR(bindmem0, CSR_BINDMEM0)
DECLARE_CSR(bindmem1, CSR_BINDMEM1)
DECLARE_CSR(bindmem2, CSR_BINDMEM2)
DECLARE_CSR(bindmem3, CSR_BINDMEM3)
DECLARE_CSR(bindmem4, CSR_BINDMEM4)
DECLARE_CSR(bindmem5, CSR_BINDMEM5)
DECLARE_CSR(bindmem6, CSR_BINDMEM6)
DECLARE_CSR(bindmem7, CSR_BINDMEM7)
DECLARE_CSR(bindmem8, CSR_BINDMEM8)
DECLARE_CSR(bindmem9, CSR_BINDMEM9)
DECLARE_CSR(bindmem10, CSR_BINDMEM10)
DECLARE_CSR(bindmem11, CSR_BINDMEM11)
DECLARE_CSR(bindmem12, CSR_BINDMEM12)
DECLARE_CSR(bindmem13, CSR_BINDMEM13)
DECLARE_CSR(bindmem14, CSR_BINDMEM14)
DECLARE_CSR(bindmem15, CSR_BINDMEM15)
DECLARE_CSR(bindmem16, CSR_BINDMEM16)
DECLARE_CSR(bindmem17, CSR_BINDMEM17)
DECLARE_CSR(bindmem18, CSR_BINDMEM18)
DECLARE_CSR(bindmem19, CSR_BINDMEM19)
DECLARE_CSR(bindmem20, CSR_BINDMEM20)
DECLARE_CSR(bindmem21, CSR_BINDMEM21)
DECLARE_CSR(bindmem22, CSR_BINDMEM22)
DECLARE_CSR(bindmem23, CSR_BINDMEM23)
DECLARE_CSR(bindmem24, CSR_BINDMEM24)
DECLARE_CSR(bindmem25, CSR_BINDMEM25)
DECLARE_CSR(bindmem26, CSR_BINDMEM26)
DECLARE_CSR(bindmem27, CSR_BINDMEM27)
DECLARE_CSR(bindmem28, CSR_BINDMEM28)
DECLARE_CSR(bindmem29, CSR_BINDMEM29)
DECLARE_CSR(bindmem30, CSR_BINDMEM30)
DECLARE_CSR(bindmem31, CSR_BINDMEM31)
DECLARE_CSR(vbindmem0, CSR_VBINDMEM0)
DECLARE_CSR(vbindmem1, CSR_VBINDMEM1)
DECLARE_CSR(vbindmem2, CSR_VBINDMEM2)
DECLARE_CSR(vbindmem3, CSR_VBINDMEM3)
DECLARE_CSR(vbindmem4, CSR_VBINDMEM4)
DECLARE_CSR(vbindmem5, CSR_VBINDMEM5)
DECLARE_CSR(vbindmem6, CSR_VBINDMEM6)
DECLARE_CSR(vbindmem7, CSR_VBINDMEM7)
DECLARE_CSR(vbindmem8, CSR_VBINDMEM8)
DECLARE_CSR(vbindmem9, CSR_VBINDMEM9)
DECLARE_CSR(vbindmem10, CSR_VBINDMEM10)
DECLARE_CSR(vbindmem11, CSR_VBINDMEM11)
DECLARE_CSR(vbindmem12, CSR_VBINDMEM12)
DECLARE_CSR(vbindmem13, CSR_VBINDMEM13)
DECLARE_CSR(vbindmem14, CSR_VBINDMEM14)
DECLARE_CSR(vbindmem15, CSR_VBINDMEM15)
DECLARE_CSR(vbindmem16, CSR_VBINDMEM16)
DECLARE_CSR(vbindmem17, CSR_VBINDMEM17)
DECLARE_CSR(vbindmem18, CSR_VBINDMEM18)
DECLARE_CSR(vbindmem19, CSR_VBINDMEM19)
DECLARE_CSR(vbindmem20, CSR_VBINDMEM20)
DECLARE_CSR(vbindmem21, CSR_VBINDMEM21)
DECLARE_CSR(vbindmem22, CSR_VBINDMEM22)
DECLARE_CSR(vbindmem23, CSR_VBINDMEM23)
DECLARE_CSR(vbindmem24, CSR_VBINDMEM24)
DECLARE_CSR(vbindmem25, CSR_VBINDMEM25)
DECLARE_CSR(vbindmem26, CSR_VBINDMEM26)
DECLARE_CSR(vbindmem27, CSR_VBINDMEM27)
DECLARE_CSR(vbindmem28, CSR_VBINDMEM28)
DECLARE_CSR(vbindmem29, CSR_VBINDMEM29)
DECLARE_CSR(vbindmem30, CSR_VBINDMEM30)
DECLARE_CSR(vbindmem31, CSR_VBINDMEM31)
DECLARE_CSR(vbindmemdesc0, CSR_VBINDMEMDESC0)
DECLARE_CSR(vbindmemdesc1, CSR_VBINDMEMDESC1)
DECLARE_CSR(vbindmemdesc2, CSR_VBINDMEMDESC2)
DECLARE_CSR(vbindmemdesc3, CSR_VBINDMEMDESC3)
DECLARE_CSR(vbindmemdesc4, CSR_VBINDMEMDESC4)
DECLARE_CSR(vbindmemdesc5, CSR_VBINDMEMDESC5)
DECLARE_CSR(vbindmemdesc6, CSR_VBINDMEMDESC6)
DECLARE_CSR(vbindmemdesc7, CSR_VBINDMEMDESC7)
DECLARE_CSR(vbindmemdesc8, CSR_VBINDMEMDESC8)
DECLARE_CSR(vbindmemdesc9, CSR_VBINDMEMDESC9)
DECLARE_CSR(vbindmemdesc10, CSR_VBINDMEMDESC10)
DECLARE_CSR(vbindmemdesc11, CSR_VBINDMEMDESC11)
DECLARE_CSR(vbindmemdesc12, CSR_VBINDMEMDESC12)
DECLARE_CSR(vbindmemdesc13, CSR_VBINDMEMDESC13)
DECLARE_CSR(vbindmemdesc14, CSR_VBINDMEMDESC14)
DECLARE_CSR(vbindmemdesc15, CSR_VBINDMEMDESC15)
DECLARE_CSR(vbindmemdesc16, CSR_VBINDMEMDESC16)
DECLARE_CSR(vbindmemdesc17, CSR_VBINDMEMDESC17)
DECLARE_CSR(vbindmemdesc18, CSR_VBINDMEMDESC18)
DECLARE_CSR(vbindmemdesc19, CSR_VBINDMEMDESC19)
DECLARE_CSR(vbindmemdesc20, CSR_VBINDMEMDESC20)
DECLARE_CSR(vbindmemdesc21, CSR_VBINDMEMDESC21)
DECLARE_CSR(vbindmemdesc22, CSR_VBINDMEMDESC22)
DECLARE_CSR(vbindmemdesc23, CSR_VBINDMEMDESC23)
DECLARE_CSR(vbindmemdesc24, CSR_VBINDMEMDESC24)
DECLARE_CSR(vbindmemdesc25, CSR_VBINDMEMDESC25)
DECLARE_CSR(vbindmemdesc26, CSR_VBINDMEMDESC26)
DECLARE_CSR(vbindmemdesc27, CSR_VBINDMEMDESC27)
DECLARE_CSR(vbindmemdesc28, CSR_VBINDMEMDESC28)
DECLARE_CSR(vbindmemdesc29, CSR_VBINDMEMDESC29)
DECLARE_CSR(vbindmemdesc30, CSR_VBINDMEMDESC30)
DECLARE_CSR(vbindmemdesc31, CSR_VBINDMEMDESC31)
